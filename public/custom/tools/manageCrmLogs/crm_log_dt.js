...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        var crmLogTableRoute = $("#crm_log_dt").data("table-route");
        dt = $("#crm_log_dt").DataTable({
            searchDelay: 500,
            processing: true,
            paging: true,
            serverSide: true,
                        ...
                        return (
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
                                  <a href="#" id="delete_crm_log" data-id="` +
                            data.id +
                            `" data-action="` +
                            data.action +
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector("#crmLogSearch");
...
KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off("change", "#crmLogSearch");
    jQuery(document).on("change", "#crmLogSearch", function (e) {
        if ($(this).val().length == 0) {
            $("#crm_log_dt")
                .DataTable()
                .search($("#crmLogSearch").val())
                .draw();
        }
    });
