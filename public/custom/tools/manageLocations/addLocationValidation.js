// Class definition
var addLocationValidation = (function () {
    // Private functions
    var initDatatable = function () {
        const fv = FormValidation.formValidation(
            document.getElementById("add_location_form"),
            {
                fields: {
                    location_name: {
                        validators: {
        ...
        fv.on("core.form.valid", function () {
            ...
            document
                .getElementById("addLocationSubmitBtn")
                .setAttribute("data-kt-indicator", "on");

            // Disable button to avoid multiple click
            document.getElementById("addLocationSubmitBtn").disabled = true;

            // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
            var formx = $("#add_location_form")[0]; // You need to use standart javascript object here
            var formDatax = new FormData(formx);
            var locationAddRoute = $("#addLocationSubmitBtn").data(
                "form-add-route"
            );
            $.ajax({
                url: locationAddRoute,
                type: "POST",
                data: formDatax,
                contentType: false,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $("#add_location_form").trigger("reset");
