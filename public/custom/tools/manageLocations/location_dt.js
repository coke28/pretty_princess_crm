...
var KTDatatablesServerSide = (function () {
    ...
    var initDatatable = function () {
        var locationTableRoute = $("#location_dt").data("table-route");
        dt = $("#location_dt").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [[0, "desc"]],
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-kt-docs-table-filter="edit_row" id="edit_location_btn" data-id="` +
                            data.id +
                            `" data-bs-toggle="modal" data-bs-target="#editLocation">
                                    Edit
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="#" id="delete_location" data-id="` +
                            data.id +
                            `" data-locationname="` +
                            data.location_name +
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector("#locationSearch");
...
KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off("change", "#locationSearch");
    jQuery(document).on("change", "#locationSearch", function (e) {
