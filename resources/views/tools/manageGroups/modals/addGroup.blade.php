    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="add_group_form">
                    ...
                    <div class="error-box" style="display: none;">
                        ...
                        <div id="group_description_error" class="error-message"></div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="addGroupSubmitBtn" class="btn btn-primary font-weight-bold"
                    data-form-add-route="{{ route('group.add') }}">Add Group</button>
            </div>
            </form>
        </div>
    </div>
