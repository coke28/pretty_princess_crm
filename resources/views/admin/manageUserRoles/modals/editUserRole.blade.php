...
<div class="modal fade" id="editUserRole" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="editUserRole" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="edit_user_role_form">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="editUserRoleSubmitBtn" class="btn btn-primary font-weight-bold">Edit
                            User
                            Role</button>
                    </div>
                </form>
